...
class TestBpTracker(unittest.TestCase):
    ...
    def test_list_low_high_avg(self):
        # Pass in hard coded data, test the result values.
        self.assertEqual(
            (70, 90, 80), bp_tracker.list_low_high_avg([90, 70, 80])
        )
    ...
    def test_get_label(self):
        ...
        self.assertTrue(
            bp_tracker.get_label(70, bp_tracker.systolics) == "low"
        )
        self.assertTrue(
            bp_tracker.get_label(56, bp_tracker.diastolics) == "low"
        )

        # Test at upper boundry
        self.assertTrue(
            bp_tracker.get_label(179, bp_tracker.systolics) == "high: stage 2"
        )
        self.assertTrue(
            bp_tracker.get_label(119, bp_tracker.diastolics) == "high: stage 2"
        )

        # Test out of bounds
        self.assertTrue(bp_tracker.get_label(-1, bp_tracker.systolics) == None)
        self.assertTrue(
            bp_tracker.get_label(301, bp_tracker.diastolics) == None
        )
